...
def result_detail(run_id: str) -> dict:
    ...
    run = _camel_row(run_row);run["sopConfig"] = _json_value(run.pop("sopConfigJson",None),{});run["triggerPayload"] = _json_value(run.pop("triggerPayloadJson",None),{});run["lastReasonParams"] = _json_value(run.pop("lastReasonParamsJson",None),{})
